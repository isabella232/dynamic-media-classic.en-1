...
1. Open the Metadata panel and do one or both of the following:
    ...
    * Choose a Preset Value, and then click **[!UICONTROL Apply]** to populate metadata fields with preset values. Company administrators create these preset values.

1. Enter values in the Metadata panel.

>[!NOTE]
>
>To edit the metadata of several assets at once, select the assets and click **[!UICONTROL File]** > **[!UICONTROL Edit Info]**. Edits you make to metadata in the Edit Info window apply to all the assets you selected.
...
1. Click **[!UICONTROL Keywords]**.
1. To add keywords, do any of the following:

    * Type a keyword in the text box and click **[!UICONTROL Add]**.
    * Click a keyword in the **[!UICONTROL Keyword Suggestions]** table.

1. To remove a keyword, select it and click **[!UICONTROL Remove]**. It moves to the Keyword Suggestions table.
...
1. In the **[!UICONTROL Upload Metadata]** dialog box, click **[!UICONTROL Browse]**.
...
On the Global Navigation bar, click **[!UICONTROL Upload]**. To import the metadata, on the Upload page, click the **[!UICONTROL Via FTP]** tab, then click **[!UICONTROL Job Options]**. In the Upload Job Options dialog box, click **[!UICONTROL Job]**, then select **[!UICONTROL Process metadata files]** check box.
...
A company administrator can view a list of all available schemas. On the Global Navigation bar, click **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Metadata]** > **[!UICONTROL Metadata Schema]**.
