...
1. Above the Asset Browse panel, on the right side of the toolbar, do one of the following:
    ...
    * Click **[!UICONTROL Grid View]** or **[!UICONTROL List View]**. In the Asset Browse panel, double-click a single asset to open it in Detail View. In the URLs and Embed Code panel on the right, click **[!UICONTROL Copy URL]** to the right of the viewer you want.
