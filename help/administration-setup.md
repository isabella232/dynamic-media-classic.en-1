...
1. Enter the name and email address of the user or administrator that you want to add, then click **[!UICONTROL Next]**.
...
1. If you want to add the user to a group (if you are adding a Media Portal user or contributor), click **[!UICONTROL Next]** and add the user.
1. Click **[!UICONTROL Save]** to complete the user setup.

   After saving, a prompt asks if you want to add a user to another company. Click **[!UICONTROL Add]** if you want to add the user to a company.
   ...
   When adding new Media Portal users, you can also go to **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL User Administration]**, then click **[!UICONTROL Upload User List]** and select a .csv file containing no more than 500 users.
...
1. Click **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Administration Setup]** > **[!UICONTROL User Administration]**.
1. Select a user from the list, and then click **[!UICONTROL Edit]**.
1. Deselect Valid.
...
1. Click **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Administration Setup]** > **[!UICONTROL User Administration]**.
1. Select the user and click **[!UICONTROL Edit]**.
1. Select the entry in the table that shows the company you are trying to modify permissions or access for, then click **[!UICONTROL Manage Company]**.
1. Select the user role.
1. If you want to change the user’s group membership (if you are editing or adding a Media Portal user or contributor), click **[!UICONTROL Next]** and edit the group membership.
1. Click **[!UICONTROL Save]**.
...
* **Filter by field name** - Select **[!UICONTROL Enable Filter By Field]**. Then select the **[!UICONTROL By Field Name]** menu, choose a column for filtering the list, and select the Filter Character menu and choose a letter. The list is filtered on one of the columns by the letter you chose. To see the full list, deselect the **[!UICONTROL Enable Filter By Field]** option.

* **Filter out invalid users** - Deselect **[!UICONTROL Include Invalid]**. The search results display only users who are in the system. Invalid users have been deleted from the system and the accounts you administer.
...
Dynamic Media Classic Administrators can generate bandwidth, storage, and other types of reports for the companies they administer. These reports are available on the Bandwidth & Storage page.

To open this page, click **[!UICONTROL Setup]** > **[!UICONTROL Personal Setup]**. Expand **[!UICONTROL Administration Setup]**, and then click **[!UICONTROL Bandwidth & Storage]**.
...
1. Choose **[!UICONTROL Setup]** > **[!UICONTROL Personal Setup]**.
1. Expand Administration Setup, and then click **[!UICONTROL Bandwidth & Storage]**.
1. Click a tab: **[!UICONTROL Bandwidth]**, **[!UICONTROL Storage]**, **[!UICONTROL Image Content]**, **[!UICONTROL Domain]**, **[!UICONTROL Video Streaming]**, or **[!UICONTROL Video Content]**.
...
* **Viewing data in a chart or data grid** - Click **[!UICONTROL Chart View]** to view data in a chart; click **[!UICONTROL Data View]** to view data in a data grid.

* **Choosing a report presentation type** - On the Report Type menu, click **[!UICONTROL Summary]**, **[!UICONTROL Daily]**, or **[!UICONTROL Monthly]** to organize data in summary form, by day, or by month. Not all reports provide this option.

* **Specifying a time period** - Choose options to define a time period for your report, and then click **[!UICONTROL Update]** after you define a time period:
...
* **Custom time period** - On the Pre-defined Report menu, click **[!UICONTROL Custom]**. Then choose a date on the **[!UICONTROL Start Month]** (or **[!UICONTROL Start Date]**) menu and a date on the # of Months (or # or Days) menu. For Domain and Video Content Reports, you can choose a specific start and end date for capturing report information.
...
Dynamic Media Classic Administrators can generate Image Error reports. An Image Error report provides a list of the 20 most frequent image errors, for the past 24 hours, for the company you are currently logged in to. To generate an Image Error report, do the following:

1. Click **[!UICONTROL Setup]** > **[!UICONTROL Personal Setup]**.
1. Expand Administration Setup, and then click **[!UICONTROL Image Errors]**.
1. (Optional) Do any of the following:

    * To sort errors by the heading information, click a heading. By default, errors are sorted by number of occurrences, highest to lowest.
    ...
    * To copy the link to the actual image, click **[!UICONTROL URL Copy URL]**. You can paste this link in a browser window to go to the image and investigate the error.
    * To copy the link to the referrer web page, click **[!UICONTROL Referrer Copy URL]**.
