...
* [Best practices to deliver interactive experiences with Dynamic Media Classic](https://seminars.adobeconnect.com/p7wb8ej3u6d/) - This webinar teaches you how to get content in and out of Dynamic Media Classic. Learn how to set up image presets for optimal performance and best experience. You also learn about viewer presets and caching configurations.
...
See all the popular resources available for [Dynamic Media Classic](home.md).
