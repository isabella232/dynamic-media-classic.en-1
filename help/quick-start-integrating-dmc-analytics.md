---
title: "Quick Start: Integrating Adobe Dynamic Media Classic and Adobe Analytics"
description: An introduction and Quick Start to integrating Adobe Dynamic Media Classic and Adobe Analytics to help you get up and running quickly.
contentOwner: admin
...
---
# Quick Start: Integrating Adobe Dynamic Media Classic and Adobe Analytics {#quick-start-integrating-dmc-analytics}
...
After you click **[!UICONTROL Save]** in the Adobe Analytics Configuration page, customized tracking code for measuring user activity is inserted in Adobe Dynamic Media Classic viewers. This functionality lets you track user activity in Adobe Analytics reports.
