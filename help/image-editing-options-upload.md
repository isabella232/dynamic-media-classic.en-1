...
These options are on the Upload page under Image Editing Options.
...
To create a mask for the image based on its clipping path information, click **[!UICONTROL Create Mask From Clipping Path]**. This option applies to images created with image-editing applications in which a clipping path was created.
